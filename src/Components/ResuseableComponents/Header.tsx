...
// type MegaMenuMultiColumn = {
//     columns: MegaMenuColumn[];
// };

// type MegaMenuSingleColumn = {
//     dropdownItems: MenuItem[];
//     dropdownStyle?: React.CSSProperties;
// };

// // ----------------------
// // Dropdown Item Component (FIXED)
// // ----------------------
...
// // ----------------------
// const MultiColumnMenu = ({ columns }: MegaMenuMultiColumn) => (
//     <div className="rts-mega-menu" style={{ top: '101%' }}>
//         <div className="wrapper">
//             <div className="container">
//                 <div className="row g-0">
...
// // ----------------------
// // Single Column Mega Menu (About, Member)
// // ----------------------
// const SingleColumnMenu = ({
//     items,
//     dropdownStyle,
...
//                                 <div className="main-header">
//                                     <div className="nav-area">
//                                         <ul>{mainNav.map(renderNavItem)}</ul>
//                                     </div>
...
type NavMegaMultiColumnItem = {
  type: 'mega-menu-multi-column';
  title: string;
  href: string;
  columns: MegaMenuColumn[];
};

type NavMegaSingleColumnItem = {
  type: 'mega-menu-single-column';
  title: string;
  href: string;
  dropdownItems: MenuItem[];
  dropdownStyle?: React.CSSProperties;
...
type HeaderData = {
  topBar: TopBar;
  logo: Logo;
  mobileMenuIcon: MobileIcon;
  mainNav: MainNavItem[];
};

// Cast imported JSON to the typed shape
...
// Multi Column Mega Menu (Services)
// ----------------------
type MultiColumnMenuProps = {
  columns: MegaMenuColumn[];
};

const MultiColumnMenu = ({ columns }: MultiColumnMenuProps) => (
  <div className="rts-mega-menu" style={{ top: '101%' }}>
    <div className="wrapper">
      <div className="container">
        <div className="row g-0">
          {columns.map((column: MegaMenuColumn, colIndex: number) => (
            <div key={colIndex} className="col-lg-3">
              <ul className="mega-menu-item with-list parent-nav">
                {column.map((item: MenuItem, itemIndex: number) => (
                  <DropdownItem key={itemIndex} item={item} />
                ))}
              </ul>
            </div>
...
// Single Column Mega Menu (About, Member)
// ----------------------
type SingleColumnMenuProps = {
  items: MenuItem[];
  dropdownStyle?: React.CSSProperties;
};

const SingleColumnMenu = ({ items, dropdownStyle }: SingleColumnMenuProps) => (
  <div className="rts-mega-menu" style={{ ...dropdownStyle, top: '101%' }}>
    <div className="wrapper">
      <div style={{ maxWidth: '300px' }}>
        <div className="row g-0">
            ...
            <div className="col-lg-12">
              <div className="header-top-one-wrapper nav-cta-layout">
                ...
                <div className="right top-cta-contact">
                  ...
                  <ul className="social-wrapper-one">
                    {topBar.socialLinks.map((social: TopBarSocial, idx: number) => (
                      <li key={idx}>
                        <a
                          href={social.href}
                          aria-label={social.ariaLabel}
